...
const Placeholdertext = () => {
  return (
    <div className="flex  w-[100%] h-[30vh] md:h-[60vh] md:my-[30px] flex-col justify-center items-center  mx-auto text-center relative">
      <div className="z-20 absolute w-[90%] md:w-[60%] -rotate-[15deg] md:rotate-0">
        <h1 className="placeholder-text text-[70px] md:text-[120px] leading-[100px] font-extrabold">
