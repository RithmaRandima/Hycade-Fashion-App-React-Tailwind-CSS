    ...
    <div className="w-[100%] h-[50vh] ">
      ...
      <Parallax strength={200} className="w-[100%] h-[100%]">
        ...
        <div className="w-[100%] h-[40vh] flex flex-col bg-gradient-to-r from-black to-black/10 items-center justify-center">
          <div className="flex flex-col md:flex-row items-center px-[60px] mt-[-30px] md:mt-[40px] mb-[10px] w-[100%]">
            <p className="text-[40px] text-white tracking-[2px] md:mr-[60px] mb-[10px] font-[700]">
              subscribe
            </p>
            <div className="flex items-center md:w-[950%]">
              <input
                type="text"
                className="w-[100%] py-[10px] md:py-[13px] outline-none px-[30px] bg-transparent text-[17px] text-white border-2"
                placeholder="your email"
              />
              <p className="bg-white w-[200px] font-[700] tracking-[2px] h-[50px] md:h-[55px] flex items-center justify-center">
                subscribe
              </p>
            </div>
          </div>
          ...
          {/* footer link */}
          <div className=" w-[90%] mx-auto h-[30px] text-white mt-[10px] md:mt-[30px] flex flex-col md:flex-row items-center justify-between">
            <div>
            ...
            {/* social overlay */}
            <div className="w-fit  h-[50px] flex items-center justify-center text-white gap-[24px] text-[22px] mt-[20px] md:mt-[1px] ">
        ...
        {/* bottom */}
        <div className="flex flex-row md:justify-between justify-center w-[100%]  h-[10vh] px-10 items-center py-4 gap-7  bg-[#000000] text-white">
          ...
          <div className="hidden md:block logo relative bg-white h-[24px] italic w-[120px]">
